...
function adicionando_produto_ao_html( ean, des, cat, umb,  qtd, data, valor_und, valor_total, end_img ) {
...
"                                        <img src=\""+ "../../../../arquivos/imagens/003_login/adicionar.png" + "\" title=" + "Adicionar" + 
                                             " onclick=\"enviando_produto_proximo_do_vencimento_js_dentro_do_html('" + ean + "','" + qtd + "','" + data + "','" + des + "','" + umb + "','" + cat + "','" + valor_und + "','" + valor_total + "');\" width=\"100\" height=\"40\" style=\"cursor: pointer\" > " +
"                                    </td>" +
"                                </tr>" +
"<!-- BOTAO NOVA LINHA +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->" +
...
"<!-- FIM DOS DADOS DO PRODUTO - id=\"ean\" +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ --> ";
            ...
            document.getElementById("lista_de_produtos_controle_jmary_systems").innerHTML = html;
